...
MgrUser.initColumn = function () {
    var columns = [
        ...
        {title: '账号', field: 'login_id', align: 'center', valign: 'middle', sortable: true},
        {title: '姓名', field: 'true_name', align: 'center', valign: 'middle', sortable: true},
    ...
    if (this.check()) {
        ...
        var operation = function(){
            ...
            var ajax = new $ax(Feng.ctxPath + "/mgr/delete", function () {
                ...
                Feng.error("删除失败!" + data.responseJSON.errorMsg + "!");
            });
...
MgrUser.freezeAccount = function () {
    if (this.check()) {
        ...
        var ajax = new $ax(Feng.ctxPath + "/mgr/freeze", function (data) {
            ...
            Feng.error("冻结失败!" + data.responseJSON.errorMsg + "!");
        });
        ajax.set("userId", userId);
        ajax.start();
    }
