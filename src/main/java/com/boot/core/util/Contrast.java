...
import com.boot.core.common.constant.dictmap.base.AbstractDictMap;
import com.boot.core.common.constant.dictmap.factory.DictFieldWarpperFactory;
    ...
    public static String contrastObj(Class dictClass, String key, Object pojo1, Map<String, String> pojo2) throws IllegalAccessException, InstantiationException {
        ...
        try {
            ...
            for (Field field : fields) {
                ...
                //解决intro(简介)乱码
                if ("intro".equals(StrUtil.lowerFirst(getMethod.getName().substring(3)))) {
