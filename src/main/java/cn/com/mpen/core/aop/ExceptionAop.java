package cn.com.mpen.core.aop;

import cn.com.mpen.core.common.exception.ServerErrorException;
import cn.com.mpen.core.kernel_core.util.HttpContext;
...
import cn.com.mpen.core.log.factory.LogTaskFactory;
...
import static cn.com.mpen.core.kernel_core.util.HttpContext.getIp;
import static cn.com.mpen.core.kernel_core.util.HttpContext.getRequest;
...
public class ExceptionAop {
    ...
    @Pointcut("execution(* cn.com.mpen.*..controller.*.*(..))")
    ...
    public Object exceptionIntercept(ProceedingJoinPoint point) throws Throwable {
        ...
        try {
            ...
            String declaringTypeName = signature.getDeclaringTypeName();//cn.com.mpen.modular.system.controller.LoginController
