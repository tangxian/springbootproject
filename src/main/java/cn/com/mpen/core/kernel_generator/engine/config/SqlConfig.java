...
import cn.com.mpen.core.kernel_model.enums.YesOrNotEnum;
...
public class SqlConfig {
    ...
    private List<cn.com.mpen.core.kernel_generator.engine.config.Menu> menus = new ArrayList(6);
    ...
    public void init() {
        ...
        cn.com.mpen.core.kernel_generator.engine.config.Menu menu = new cn.com.mpen.core.kernel_generator.engine.config.Menu();
        ...
        cn.com.mpen.core.kernel_generator.engine.config.Menu list = createSubMenu(menu);
        ...
        cn.com.mpen.core.kernel_generator.engine.config.Menu add = createSubMenu(menu);
        ...
        cn.com.mpen.core.kernel_generator.engine.config.Menu update = createSubMenu(menu);
        ...
        cn.com.mpen.core.kernel_generator.engine.config.Menu delete = createSubMenu(menu);
        ...
        cn.com.mpen.core.kernel_generator.engine.config.Menu detail = createSubMenu(menu);
    ...
    private cn.com.mpen.core.kernel_generator.engine.config.Menu createSubMenu(cn.com.mpen.core.kernel_generator.engine.config.Menu parentMenu) {
        cn.com.mpen.core.kernel_generator.engine.config.Menu menu = new cn.com.mpen.core.kernel_generator.engine.config.Menu();
        menu.setId(Long.valueOf(IdWorker.getId()));
    ...
    public List<cn.com.mpen.core.kernel_generator.engine.config.Menu> getMenus() {
        return this.menus;
    }
