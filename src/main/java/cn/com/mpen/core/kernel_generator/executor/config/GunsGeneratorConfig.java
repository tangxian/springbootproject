package cn.com.mpen.core.kernel_generator.executor.config;
...
public class GunsGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void packageConfig() {
        ...
        this.packageConfig.setEntity("cn.com.mpen.modular.system.model");
        this.packageConfig.setMapper("cn.com.mpen.modular.system.dao");
        this.packageConfig.setXml("cn.com.mpen.modular.system.dao.mapping");
    }

    protected void contextConfig() {
        this.contextConfig.setProPackage("cn.com.mpen.admin");
        this.contextConfig.setCoreBasePackage("cn.com.mpen.core");
