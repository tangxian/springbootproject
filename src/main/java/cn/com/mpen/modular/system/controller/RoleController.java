...
import cn.com.mpen.core.common.constant.cache.Cache;
import cn.com.mpen.core.common.constant.dictmap.RoleDict;
...
import cn.com.mpen.core.util.CacheUtil;
import cn.com.mpen.core.util.NetworkResult;
import cn.com.mpen.modular.system.model.Role;
import cn.com.mpen.modular.system.model.User;
import cn.com.mpen.modular.system.service.IRoleService;
import cn.com.mpen.modular.system.service.IUserService;
import cn.com.mpen.modular.system.warpper.RoleWarpper;
...
public class RoleController extends BaseController {
    ...
    @ResponseBody
    public NetworkResult view(@PathVariable Integer roleId) {
        if (ToolUtil.isEmpty(roleId)) {
            throw new ServiceException(BizExceptionEnum.REQUEST_NULL);
        }
    ...
    @ResponseBody
    public List<Map<Integer,String>> getRoleList() {
