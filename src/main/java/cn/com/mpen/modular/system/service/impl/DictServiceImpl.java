 ...
 */
package cn.com.mpen.modular.system.service.impl;

import cn.com.mpen.core.common.constant.factory.ConstantFactory;
import cn.com.mpen.core.common.constant.factory.MutiStrFactory;
import cn.com.mpen.core.common.exception.BizExceptionEnum;
import cn.com.mpen.core.kernel_model.exception.ServiceException;
import cn.com.mpen.modular.system.dao.DictMapper;
import cn.com.mpen.modular.system.model.Dict;
import cn.com.mpen.modular.system.service.IDictService;
...
public class DictServiceImpl extends ServiceImpl<DictMapper, Dict> implements IDictService {
    ...
    public void delteDict(Integer dictId) {
        ...
        //清除缓存
        List<Dict> dicts = dictMapper.selectList(dictEntityWrapper);
        Dict dict_parent = dictMapper.selectById(dictId);
        for (Dict dict : dicts) {
            ConstantFactory.me().delDictsByName(dict_parent.getName(),dict.getNum());
        }
        ConstantFactory.me().delDictsByParentCode(dict_parent.getCode());
        //删除这个字典的子词典
    ...
    @Override
    public Dict getDrcCloudDivided(String code, String name) {
        return this.baseMapper.getDrcCloudDivided(code,name);
    }
}
