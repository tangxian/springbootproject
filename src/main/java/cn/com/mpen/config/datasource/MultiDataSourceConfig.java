...
package cn.com.mpen.config.datasource;

import cn.com.mpen.core.kernel_core.config.properties.DruidProperties;
import cn.com.mpen.core.kernel_core.config.properties.MutiDataSourceProperties;
import cn.com.mpen.core.kernel_core.datascope.DataScopeInterceptor;
import cn.com.mpen.core.kernel_core.mutidatasource.DynamicDataSource;
import cn.com.mpen.core.kernel_core.mutidatasource.aop.MultiSourceExAop;
...
@Configuration
@ConditionalOnProperty(prefix = "mpen.muti-datasource", name = "open", havingValue = "true")
@EnableTransactionManagement(order = 2, proxyTargetClass = true)
@MapperScan(basePackages = "cn.com.mpen.modular.*.dao")
...
/**
    ...
    @Bean
    @ConfigurationProperties(prefix = "mpen.muti-datasource")
